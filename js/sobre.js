...
class LiPillarsOfAction extends LiSection {
  ...
  render() {
    const items = [
      { svg: 'chart-trend-yellow',  title: 'Observatório', desc: 'Mapeamento em tempo real do contexto urbano e recolha de dados estatísticos rigorosos sobre a população flutuante da cidade.' },
