export const storiesPreviewCSS = `
  ...
  h2 { font-family: 'Inter', sans-serif; font-weight: 900; font-size: 72px; line-height: 72px; letter-spacing: 0px; color: var(--text-dark); }
  h2 em { font-family: 'Inter', sans-serif; font-weight: 900; font-size: 72px; line-height: 72px; letter-spacing: 0px; font-style: normal; display: inline; color: #724D9B; }
  ...
  .img { height: 455px; aspect-ratio: 341.33 / 455.09; background-size: cover; background-position: center top; position: relative; }
