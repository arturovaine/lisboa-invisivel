export const missionCSS = `
  ...
  h2 { font-family: 'Inter', sans-serif; font-weight: 900; font-size: 60px; line-height: 60px; letter-spacing: 0px; color: var(--text-dark); max-width: 22ch; margin-bottom: 4rem; }
