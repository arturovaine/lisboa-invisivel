export const statsCSS = `
  ...
  .card.dark { background: var(--purple-dark); color: #FAF8F2; }
  .card.dark::before, .card.dark::after { content: ''; position: absolute; width: 24px; height: 24px; }
  .card.dark::before { top: 0; left: 0; border-top: 3px solid var(--yellow); border-left: 3px solid var(--yellow); }
  .card.dark::after { bottom: 0; right: 0; border-bottom: 3px solid var(--yellow); border-right: 3px solid var(--yellow); }
  ...
  .footer { margin-top: 2.5rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,.1); display: flex; justify-content: space-between; align-items: center; }
  ...
  .yellow .share img { filter: brightness(0); }
